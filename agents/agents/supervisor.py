...
Rules:
- delivery: questions about delivery documents, their items, open/unassigned deliveries, delivery status
- driver: questions about drivers, assignments, who is driving, GPS tracking, confirming delivery, assigning a driver
- route: questions about routes, directions, distance, travel time
